...
void Example_WS_VA_RWG (const int Counter_start,  const int Counter_end )
{
    ...
    const double r1[] = {1.0 , 1.0 , 1.0};
    const double r2[] = {2.0 , 1.0 , 1.0};
    const double r3[] = {1.0 , 2.0 , 1.0};
    const double r4[] = {0.0 , 1.0 , 1.0};
    const double r5[] = {0.0 , 2.0, 1.0};
    ...
    for (int points = Counter_start; points < Counter_end+1; points++)
    {
        ...
        for (int i=0; i<100; i++)
        {
            demcem_ws_va_rwg ( r1, r2, r3, r4, r5, ko, N_theta_p, N_theta_q, N_psi, I_DE );
