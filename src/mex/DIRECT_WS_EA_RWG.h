#if !defined _DIRECT_WS_EA_RWG_H_
#define _DIRECT_WS_EA_RWG_H_
...
void DIRECT_WS_EA_RWG (const double r1[], const double r2[] ,const double r3[], const double r4[], const double ko, const int N_theta, const int N_psi, const double z_theta[], const double w_theta[], const double z_psi[], const double w_psi[], complex<double> I_DE[] );
