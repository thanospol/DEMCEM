...
void Example_SS_EA_nxRWG (const int Counter_start,  const int Counter_end)
{
    ...
    for (int points = Counter_start; points < Counter_end+1; points++)
    {
        ...
        for (int i=0; i<100; i++)
        {
            demcem_ss_ea_nxrwg ( r1, r2, r3, r4, ko, N_theta, N_psi, I_DE );
        ...
        //
        cout << endl;
        cout << "SS - EA - nxRWG" << endl;
        
        cout << "Points: " << points << endl;
        cout << "Runtime: " << setprecision (6) << RunTime << " [msec]" << endl << endl;
        cout << "I_g1_f1 = " << setprecision (20) << I_DE[0] << endl ;
        cout << "I_g1_f2 = " << setprecision (20) << I_DE[1] << endl ;
        cout << "I_g1_f3 = " << setprecision (20) << I_DE[2] << endl ;
        cout << "I_g2_f1 = " << setprecision (20) << I_DE[3] << endl ;
        cout << "I_g2_f2 = " << setprecision (20) << I_DE[4] << endl ;
        cout << "I_g2_f3 = " << setprecision (20) << I_DE[5] << endl ;
        cout << "I_g3_f1 = " << setprecision (20) << I_DE[6] << endl ;
        cout << "I_g3_f2 = " << setprecision (20) << I_DE[7] << endl ;
        cout << "I_g3_f3 = " << setprecision (20) << I_DE[8] << endl ;
