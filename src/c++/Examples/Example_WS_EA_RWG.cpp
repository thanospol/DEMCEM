...
void Example_WS_EA_RWG (const int Counter_start,  const int Counter_end )
{
    ...
    const double r2[] = {0.5 , 0.0 , 0.0};
    const double r3[] = {0.0 , 0.0 , 0.5};
    const double r4[] = {0.0 , 0.5 , 0.0};
    ...
    for (int points = Counter_start; points < Counter_end+1; points++)
    {
        ...
        for (int i=0; i<100; i++)
        {
            demcem_ws_ea_rwg ( r1, r2, r3, r4, ko, N_theta, N_psi, I_DE );
