...
void demcem_ss_va_rwg (const double r1[],const double r2[],const double r3[],const double r4[], const double r5[], const complex<double> ko, const int N_theta_p, const int N_theta_q, const int N_psi, complex<double> I_DE[] )
{
	...
	coefficients_ss_va_rwg ( r1,  r2,  r3,  r4, r5,  ko,  coef_f1_f2, 12 );
	coefficients_ss_va_rwg ( r1,  r2,  r3,  r4, r5,  ko,  coef_f1_f3, 13 );
	coefficients_ss_va_rwg ( r1,  r2,  r3,  r4, r5,  ko,  coef_f2_f1, 21 );
	coefficients_ss_va_rwg ( r1,  r2,  r3,  r4, r5,  ko,  coef_f2_f2, 22 );
	coefficients_ss_va_rwg ( r1,  r2,  r3,  r4, r5,  ko,  coef_f2_f3, 23 );
	coefficients_ss_va_rwg ( r1,  r2,  r3,  r4, r5,  ko,  coef_f3_f1, 31 );
	coefficients_ss_va_rwg ( r1,  r2,  r3,  r4, r5,  ko,  coef_f3_f2, 32 );
	coefficients_ss_va_rwg ( r1,  r2,  r3,  r4, r5,  ko,  coef_f3_f3, 33 );
		 ...
		 for ( int n_theta_q = 0 ; n_theta_q <  N_theta_q ; n_theta_q++ )
		 {
			...
			//
			 ...
			 for ( int n_psi = 0 ; n_psi <  N_psi ; n_psi++ )
			 {
				 ...
				 k_functions_ss_va_rwg(B_1, L1, K_1, ko);
				 k_functions_ss_va_rwg(B_2, L2, K_2, ko);
				 //
				 Omega_f1_f2_1 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_1, B_1, coef_f1_f2, ko, K_1, 12);
				 Omega_f1_f2_2 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_2, B_2, coef_f1_f2, ko, K_2, 12);
				 //
				 Omega_f1_f3_1 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_1, B_1, coef_f1_f3, ko, K_1, 13);
				 Omega_f1_f3_2 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_2, B_2, coef_f1_f3, ko, K_2, 13);
				 //
				 Omega_f2_f1_1 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_1, B_1, coef_f2_f1, ko, K_1, 21);
				 Omega_f2_f1_2 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_2, B_2, coef_f2_f1, ko, K_2, 21);
				 //
				 Omega_f2_f2_1 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_1, B_1, coef_f2_f2, ko, K_1, 22);
				 Omega_f2_f2_2 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_2, B_2, coef_f2_f2, ko, K_2, 22);
				 //
				 Omega_f2_f3_1 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_1, B_1, coef_f2_f3, ko, K_1, 23);
				 Omega_f2_f3_2 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_2, B_2, coef_f2_f3, ko, K_2, 23);
				 //
				 Omega_f3_f1_1 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_1, B_1, coef_f3_f1, ko, K_1, 31);
				 Omega_f3_f1_2 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_2, B_2, coef_f3_f1, ko, K_2, 31);
				 //
				 Omega_f3_f2_1 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_1, B_1, coef_f3_f2, ko, K_1, 32);
				 Omega_f3_f2_2 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_2, B_2, coef_f3_f2, ko, K_2, 32);
				 //
				 Omega_f3_f3_1 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_1, B_1, coef_f3_f3, ko, K_1, 33);
				 Omega_f3_f3_2 = omega_functions_ss_va_rwg(THETA_p, THETA_q, PSI_2, B_2, coef_f3_f3, ko, K_2, 33);
				 //
         		 WPSI = w_psi[n_psi];
				 //
